...
class GradleUtils {
    ...
    static getPublishingForgeMaven(Project project, File defaultFolder = project.rootProject.file('repo')) {
        return setupSnapshotCompatiblePublishing(project, 'https://maven.removeco.de/', defaultFolder)
    }
     ...
     * By default this is: https://maven.removeco.de/
     ...
     * @return a closure
     */
    static setupSnapshotCompatiblePublishing(Project project, String fallbackPublishingEndpoint = 'https://maven.removeco.de/', File defaultFolder = project.rootProject.file('repo'), File defaultSnapshotFolder = project.rootProject.file('snapshots')) {
    ...
    static getForgeReleaseMaven() {
        return { MavenArtifactRepository it ->
            name 'forge-releases'
            url 'https://maven.removeco.de/releases'
        }
    }
    ...
    static getForgeSnapshotMaven() {
        return { MavenArtifactRepository it ->
            ...
            url 'https://maven.removeco.de/snapshots'
        }
    }
